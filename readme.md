...
- [MPLAB® Harmony 3 Smart Energy Examples Help] (https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=MPLAB_Harmony_Smart_Energy_PRIME_Applications&redirect=true)
...
| [PRIME 1.3 Base Modem] (https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=SE_PRIME_apps_Base_Modem&redirect=true) | The PRIME 1.3 Base Modem is an application example that demonstrates how to configure the PRIME Stack and its serial interface as a Base Node with modem capabilies. |
| [PRIME 1.4 Base Modem] (https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=SE_PRIME_apps_Base_Modem&redirect=true) | The PRIME 1.4 Base Modem is an application example that demonstrates how to configure the PRIME Stack and its serial interface as a Base Node with modem capabilies. |
| [PRIME Dual Service Modem] (https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=SE_PRIME_apps_Service_Dual_Modem&redirect=true) | The PRIME Dual Service Modem is an application example that demonstrates how to configure the PRIME Stack and its serial interface as a dual Service Node with modem capabilies. |
