...
{
    /* Software reset SERCOM1. SWRST self-clears when the reset
     * finishes; the application's plib will configure CTRLB and
     * CTRLA from scratch on its own SERCOM1_SPI_Initialize call. */
